...
public:
    ...
    // a payload header, and an array of versioned detection entries (see object_detection_entry_v2/v3).
...
#pragma pack( pop )
    ...
    static constexpr size_t ENTRY_SIZE = sizeof( object_detection_entry_v2 );
    ...
    static_assert( sizeof( object_detection_entry_v3 ) == 36, "Object Detection v3 entry ABI must be 36 bytes" );
