...
macro(tools_target_config _target)
    ...
    if(ENABLE_AI_ASSISTANT)
        message( STATUS "AI Assistant capability added to ${_target}" )
    endif()
    if(ENABLE_STATS)
        message( STATUS "Stats monitoring capability added to ${_target}" )
        if(WIN32)
            # SHA-256 of the RUM report; elsewhere OpenSSL provides it, linked with libcurl
            set(RS_VIEWER_LIBS ${RS_VIEWER_LIBS} bcrypt.lib)
        endif()
    endif()
