...
public class MainActivity extends AppCompatActivity {
    private static final String TAG = "librs multicam TEST";
    ...
    private int numberOfFramesetReceived = 0;
    ...
    Runnable mStreaming = new Runnable() {
        ...
        public void run() {
            ...
            if (numberOfFramesetReceived++ == 20)
                finish();
        }
    };
    ...
    private void configAndStart() throws Exception {
        for(int i = 0; i < mPipelines.size(); i++) {
            try (Config config = new Config()) {
                ...
                config.enableStream(StreamType.DEPTH, 0, 848, 480, StreamFormat.Z16, 15);
                config.enableStream(StreamType.INFRARED, 1, 848, 480, StreamFormat.Y8, 15);
